        ...
        <div className="max-w-none mx-auto p-1 print:p-0">
          ...
          >
            <div className="flex h-full">
              <div 
                className="w-2/5 p-2 text-white"
                style={{ 
              ...
              <div className="w-2/3 p-3 bg-white">
                <div className="mb-2 border-b border-blue-600 pb-1">
                     ...
                     <div>
                       <div className="flex justify-between items-start">
                         <div className="flex-1">
                           ...
                           <p className="text-sm text-gray-700">
                             <span className="font-medium">Graduation:</span> {formatGraduationDate(userData.graduationMonth, userData.graduationYear)}
                           </p>
                           {userData.cgpa && (
                             <p className="text-sm text-gray-700">
